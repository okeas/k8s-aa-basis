...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/boyfoo/k8s-aa-basis/pkg/apis/myingress/v1beta1.MyIngress":     schema_pkg_apis_myingress_v1beta1_MyIngress(ref),
		"github.com/boyfoo/k8s-aa-basis/pkg/apis/myingress/v1beta1.MyIngressList": schema_pkg_apis_myingress_v1beta1_MyIngressList(ref),
		"github.com/boyfoo/k8s-aa-basis/pkg/apis/myingress/v1beta1.MyIngressSpec": schema_pkg_apis_myingress_v1beta1_MyIngressSpec(ref),
...
func schema_pkg_apis_myingress_v1beta1_MyIngress(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/boyfoo/k8s-aa-basis/pkg/apis/myingress/v1beta1.MyIngressSpec"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/boyfoo/k8s-aa-basis/pkg/apis/myingress/v1beta1.MyIngressSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_pkg_apis_myingress_v1beta1_MyIngressList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/boyfoo/k8s-aa-basis/pkg/apis/myingress/v1beta1.MyIngress"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/boyfoo/k8s-aa-basis/pkg/apis/myingress/v1beta1.MyIngress", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}
